    ...
    return (
        <>
            <nav ref={navbarRef} className={`sticky top-0 z-50 w-screen bg-white md:relative safe-layout`}>
                {/* <Banner /> */}
                <div className='flex flex-row items-center justify-between py-8 border-b-2 border-b-gray safe-x-padding'>
                    <Link className='z-50' href="/" onClick={closeMenu} prefetch={false}>
                        <div className="w-[70px] h-[50px] lg:w-[70px] lg:h-[50px]">
                       
                            <img src='https://github.com/atanu16/Portfolio/assets/83860778/bb8c343e-80a9-4a97-a519-41447c94fad8' />
                    ...
                    <div className='flex-row items-center justify-between hidden text-lg font-bold md:flex md:gap-6 lg:gap-8'>
                        ...
                        {/* <a className='px-6 py-2 text-white gradient-btn rounded-xl' href="#" download="Atanu Bera Resume">Resume</a> */}
                    </div>
