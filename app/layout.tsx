...
export const metadata = {
  title: "Atanu Bera",
  description: "Atanu Bera's portfolio, showcasing projects, skills, and blog posts related to web development and more.",
}
  ...
  return (
    <html lang="en" id='style-1' className={`${montserrat.variable} ${poppins.variable} lg:overflow-x-hidden`}>
      <head>
        ...
        <meta name="description" content="Atanu Bera's portfolio, showcasing projects, skills, and blog posts related to web development and more." />
        <meta name="keywords" content="Atanu Bera, portfolio, web developer, projects, blog, web development, frontend developer, backend developer, full-stack developer" />
