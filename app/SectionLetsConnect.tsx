    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.linkedin.com/in/atanu16/', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.instagram.com/_rozzer_/', '_blank'),
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/atanu16', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://dribbble.com/atanu16', '_blank')
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:atanumax2@gmail.com', "_self")
        }
            ...
            <div className='h-full mt-4'>
                <div className='relative flex flex-col items-center justify-center'>
                    ...
                    <div className='flex flex-row flex-wrap items-center justify-center gap-3 mt-4 lg:hidden'>
                        <AnimatedImage initial={{ y: 50, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0.4 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.linkedin} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('https://www.linkedin.com/in/atanu16/', '_blank')} />
                        <AnimatedImage initial={{ y: -50, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0.8 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.dribble} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('https://dribbble.com/atanu16', '_blank')} />
                        <AnimatedImage initial={{ y: 100, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.gmail} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('mailto:atanumax2@gmail.com', "_self")} />
                        <AnimatedImage initial={{ y: 50, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0.6 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.instagram} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('https://www.instagram.com/_rozzer_/', '_blank')} />
                        <AnimatedImage initial={{ y: -50, opacity: 0 }} animate={inView ? { y: 0, opacity: 1 } : {}} transition={{ duration: 0.5, delay: 1 }} className="z-[1] hover:cursor-pointer w-[100px] h-[100px]" src={assets.home.letsConnect.github} alt='' width={100} height={100} tabIndex={0} onClick={() => window.open('https://github.com/atanu16', '_blank')} />
                    </div>
                </div>
            </div>
        </section>
