            ...
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    <motion.p
                        ...
                        aria-label="Welcome to Atanu's Portfolio"
                    >
                        Welcome to Atanu&apos;s Portfolio
                    </motion.p>
                    <motion.h2
                    ...
                    <motion.p
                        ...
                        aria-label="I'm Atanu Bera. A passionate Game Designer based in Haldia , West Bengal, India."
                    >
                        I&apos;m Atanu Bera. A passionate Developer and UI/UX Designer From India.
                    </motion.p>
                </div>
                {/* second */}
